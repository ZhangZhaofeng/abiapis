...
# API 请求地址
MARKET_URL = "https://api.zaif.jp/api/1"
TRADE_URL = "https://api.zaif.jp/api/tapi"
...
def api_key_post(params, request_path):
    ...
    signature = hmac.new(bytearray(SECRET_KEY.encode('utf-8')), digestmod=hashlib.sha512)
    signature.update(encode_params.encode('utf-8'))
    ...
    return http_post_request(host_url, encode_params, headers)
